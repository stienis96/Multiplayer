...
public class Server
{
    ...
    public static List<ServerPlayerState> WorldState;

    public static long tick;
    public static long tickDelay = 3; // 30 ticks a second, so reasonable --166 ms for the client to send its tick (?)
    ...
    public static void Start(int maxPlayers, int port)
    {
        ...
        Server.WorldState = new List<ServerPlayerState>();
    ...
    private static void UDPReceiveCallback(IAsyncResult result)
    {
        try
        {
            ...
            using (Packet packet = new Packet(data))
            {
                ...
                if (clients[clientId].udp.endPoint == null) // New connection
                {
